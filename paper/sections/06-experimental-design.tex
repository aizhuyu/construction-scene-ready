...
\begin{figure*}[t]
\centering
\plannedfigure{43mm}{Figure 6 production placeholder: benchmark design}{
Top row: true parameterized scene views for connection-plate positioning,
pin insertion, and sequential assembly. Middle row: fixed-base, in-place
whole-body, and mobile-manipulation task levels. Bottom row: the six fault
families, development/test/challenge partitioning, and the four comparison
methods. Include the progression stop criteria but do not present planned
conditions as completed results.}{
Generated IFC fixtures and true OpenUSD/Isaac Sim renders, benchmark registry,
partition manifest, and fault taxonomy. Hybrid SVG/PDF.}
