...
faults evaluated on held-out geometric variants.}
\label{tab:benchmark}
\small
\resizebox{\textwidth}{!}{%
...
work-zone obstacle & Fixed base (executed here); whole body, mobile (benchmark progression) & 9 dev / 24 test / 2 challenge & Placement pose and state completion \\
Simplified pin insertion & Interface axis, clearance, friction, initial
misalignment & Fixed base (executed here); whole body, mobile (benchmark progression) & 9 dev / 24 test / 2 challenge & Insertion depth without jam \\
Sequential assembly & Component order, temporary support, path obstruction,
state transition & Fixed base (executed here); whole body, mobile (benchmark progression) & 9 dev / 24 test / 2 challenge & Complete legal task sequence \\
\bottomrule
\end{tabular}
}
\end{table*}
...
signal and downstream task outcome is assessed with a rank (Spearman)
correlation across conditions and a condition-level confusion structure.
