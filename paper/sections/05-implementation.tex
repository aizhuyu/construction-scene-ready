...
The frozen v0.2.0 baseline carries thirty versioned rule identifiers covering
...
and critical-property provenance; v0.3.0 adds two evidence-grounded
interface-fidelity rules (CSR-SCN-031/032), 32 in total.
