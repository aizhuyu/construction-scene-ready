...
to act on & target selection & discretely fatal (0--3.5\% success); no
perceptual compensation possible \\
Member pose (absolute) & Coarse approach and reach planning & transport &
largely compensated by closed-loop perception ($-$2.5\,pp, n.s.) \\
Interface coordinates relative to member & Fine alignment at the hole mouth
& align, insert & significant degradation from 5\,mm error (powered test);
2\,mm absorbed by the executor's tolerance band \\
Interface clearance \& tolerance & Physical insertability of the fastener
& insert & most sensitive continuous feature; $-$31.5\,pp at 0.75\,mm
clearance \\
